...
- **Generative Model**: Ollama (e.g., `llama3` or `mistral`) for local RAG query answering.
...
5. **Contextual AI Answering (RAG)**: Uses the retrieved semantic search results as context to provide a natural language answer via a local Ollama instance.
